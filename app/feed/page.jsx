      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-14 pt-16 sm:px-6">
        <div className="mb-6 flex justify-end">
          <Link
            ...
            prefetch={true}
            scroll={false}
            className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 hover:shadow-blue-600/30"
          >
