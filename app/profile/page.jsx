    ...
    return (
      <main className="relative min-h-screen overflow-x-clip bg-[radial-gradient(circle_at_10%_14%,rgba(125,211,252,0.22),transparent_30%),radial-gradient(circle_at_86%_12%,rgba(129,140,248,0.2),transparent_34%),linear-gradient(180deg,#f8fbff_0%,#f4f7fb_55%,#eef2f7_100%)] dark:bg-[radial-gradient(circle_at_10%_14%,rgba(56,189,248,0.1),transparent_30%),radial-gradient(circle_at_86%_12%,rgba(129,140,248,0.1),transparent_34%),linear-gradient(180deg,#0f172a_0%,#1e293b_100%)] transition-colors duration-500">
          ...
          <div className="rounded-3xl border border-slate-200/80 dark:border-slate-700/80 bg-white/88 dark:bg-slate-800/88 p-6 shadow-[0_14px_40px_rgba(15,23,42,0.08)] backdrop-blur-sm sm:p-8 transition-colors duration-500">
            <div className="flex flex-col items-center gap-6 md:flex-row">
              <div className="relative">
                <div className="h-32 w-32 overflow-hidden rounded-full border-4 border-white dark:border-slate-800 shadow-[0_12px_28px_rgba(15,23,42,0.15)] transition-colors duration-500">
                  <ProfileAvatar
                    src={profile_pic}
                    alt="Profile"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-slate-900/25 dark:bg-slate-900/60 backdrop-blur-sm transition-colors duration-500" />
          <div className="relative mx-4 w-full max-w-md rounded-2xl border border-slate-200/80 dark:border-slate-700/80 bg-white/95 dark:bg-slate-800/95 p-8 shadow-[0_20px_48px_rgba(15,23,42,0.18)] transition-colors duration-500">
            <Login />
          </div>
        </div>
      </main>
        ...
        <section className="rounded-3xl border border-slate-200/80 dark:border-slate-700/80 bg-white/88 dark:bg-slate-800/88 p-5 shadow-[0_10px_35px_rgba(15,23,42,0.06)] backdrop-blur-sm sm:p-6 transition-colors duration-500">
          ...
          {loadingPosts ? (
            <div className="flex items-center justify-center py-10">
              <div className="flex items-center gap-2 rounded-full border border-blue-100 dark:border-blue-900/50 bg-white dark:bg-slate-800 px-5 py-2.5 text-blue-600 dark:text-blue-400 shadow-sm transition-colors duration-500">
            ...
            <div className="grid gap-5">
              {posts.map((post) => (
                <div key={post.uid} className="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm transition-all duration-300 hover:shadow-[0_12px_30px_rgba(15,23,42,0.08)] dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.5)]">
                  <ProfileCard
                    profile={post}
                    edit={true}
                    deletePost={true}
