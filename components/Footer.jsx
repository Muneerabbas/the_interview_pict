      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-[#1877F2]">The Interview</h3>
            <p className="text-[#1D1D1D] text-sm">
              Empowering tech professionals with interview experiences and insights.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-[#1877F2] hover:text-[#8B77F9] transition-colors">
                <Github size={24} />
              </a>
              <a href="#" className="text-[#1877F2] hover:text-[#8B77F9] transition-colors">
                <Linkedin size={24} />
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-[#1D1D1D] hover:text-[#1877F2] transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-[#1D1D1D] hover:text-[#1877F2] transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-[#1D1D1D] hover:text-[#1877F2] transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-[#1D1D1D] hover:text-[#1877F2] transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2">
                <Phone size={18} className="text-[#1877F2]" />
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-2">
              ...
              <button
                type="submit"
                className="w-full p-2 bg-[#1877F2] text-white rounded-lg hover:bg-[#8B77F9] transition-colors duration-300"
              >
                Subscribe
              </button>
