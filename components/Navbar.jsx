...
export default function Navbar() {
  ...
  const onSearch = (event) => {
    ...
    const query = searchText.trim() || "interview";
  ...
  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-border-dark bg-background-dark/95 backdrop-blur-md">
