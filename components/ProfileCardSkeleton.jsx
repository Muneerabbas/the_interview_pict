...
const ProfileCardSkeleton = () => {
  return (
    <div className="w-full mx-auto animate-pulse overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_5px_20px_rgba(15,23,42,0.06)] dark:border-slate-700 dark:bg-slate-900 dark:shadow-[0_10px_30px_rgba(2,6,23,0.55)]">
      ...
      <div className="p-5 sm:p-6">
        <div className="mb-4 flex items-start justify-between gap-4 border-b border-slate-100 pb-4 dark:border-slate-700">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="h-5 w-40 rounded-md bg-slate-200 dark:bg-slate-700"></div>
              <div className="mt-2 h-3 w-28 rounded-md bg-slate-200 dark:bg-slate-700"></div>
            </div>
          </div>
        ...
        <div className="mb-4 flex flex-wrap gap-2.5">
          <div className="h-8 w-40 rounded-lg bg-slate-200 dark:bg-slate-700"></div>
        ...
        <div className="mt-6 h-4 w-36 rounded-md bg-slate-200 dark:bg-slate-700"></div>
      </div>
    </div>
  );
};
