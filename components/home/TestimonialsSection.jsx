...
export default function TestimonialsSection() {
  return (
    <section className="relative overflow-hidden bg-slate-950 px-4 pb-14 pt-8 text-slate-100 sm:pb-16 sm:pt-10">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto flex w-full max-w-7xl gap-5 overflow-x-auto pb-2">
          {blogPosts.map((post, index) => (
            <article
              key={`${post.author}-${index}`}
              className="group min-w-[280px] max-w-[350px] rounded-2xl border border-slate-800/80 bg-slate-900/95 p-5 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_0_20px_rgba(13,127,242,0.1)] sm:min-w-[320px] sm:max-w-[320px] sm:p-6"
            >
