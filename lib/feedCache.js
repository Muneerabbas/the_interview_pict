export const FEED_SORT_RANDOM = "random";

export function normalizeFeedSort(sortParam) {
  if (sortParam === FEED_SORT_TRENDING) return FEED_SORT_TRENDING;
  if (sortParam === FEED_SORT_RANDOM) return FEED_SORT_RANDOM;
  return FEED_SORT_LATEST;
}
