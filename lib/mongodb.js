...
// MONGODB_DB_NAME is often unset (the URI carries /int-exp). The app survived
// because client.db(undefined) falls back to the URI path, but next-sitemap
// bailed outright and shipped a sitemap with zero post/company URLs.
export const MONGODB_DB_NAME = process.env.MONGODB_DB_NAME || "int-exp";
